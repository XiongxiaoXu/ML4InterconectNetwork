# python run.py --RIDPID R0L0 --placement cont-adp --method LSTM --backward_window_size 13 --forward_window_size 1 --online
...
parser.add_argument('--RIDPID', type=str, help='main port')
...
parser.add_argument('--method', type=str, choices = ['LSTM', 'ARIMA'], help='method to predict')
...
if args.method == 'ARIMA':
    predict = ARIMA_alg(train, test, args)
elif args.method == 'LSTM':
    predict = LSTM_alg(train, test, args)
end = time.time()
